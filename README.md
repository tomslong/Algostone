...
![AlgoStone Demo](docs/demo.gif)

---

## 简介

AlgoStone 是一款智能算法学习平台，通过 AI 对话式引导帮助你深度理解算法思维，而不是简单地给出答案。

与传统刷题平台不同，我们的 AI 教练会像身边的大牛一样，根据你的代码状态提供阶梯式提示——从算法方向到关键步骤，再到伪代码框架，循序渐进地引导你独立思考并解决问题。

无论你是算法初学者还是面试备战者，AlgoStone 都能让你在真实的编程练习中培养出真正的解题能力，而不是死记硬背别人的题解。
